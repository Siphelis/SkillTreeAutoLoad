...
L.BTN_ON = "SÍ"
L.BTN_OFF = "NO"
L.ROW_NEXT_STEP = "+%d nodo(s) - %s Soul Ashes"
L.ROW_BLOCKED = "Faltan %s Soul Ashes para el siguiente nodo"
L.TOOLTIP_PROGRESS = "Progreso: %d/%d nodos - %s de %s Soul Ashes"
L.TOOLTIP_MODE_PROGRESSIVE = "Progresivo: compra lo que puedas pagar, del nodo más barato al más caro."
L.TOOLTIP_MODE_STRICT = "Completo: espera a que todo el guardado sea pagable."
L.TOOLTIP_LEGEND_NOW = "En verde en el árbol: lo que toma este clic."
L.TOOLTIP_LEGEND_LATER = "En ámbar en el árbol: aún fuera de alcance."
L.MSG_APPLIED_PARTIAL = "'%s' avanzado: %d nodo(s), %s Soul Ashes gastados, %d restante(s). Pulsa 'Apply Changes' para confirmar."
L.MSG_NOTHING_AFFORDABLE = "No hay suficientes Soul Ashes para un solo nodo de '%s'."
L.ERR_NO_GRAPH = "grafo del árbol no disponible"
